 ...
 **Note**: When backing up to a network drive (i.e. SAMBA), it is unclear if long path > 260 work in practice with YAHB 1.0.5. and the above mentioned registry entry. Feedback is appreciated!
